...
class Order(models.Model):
    ...
    form_assessment = models.OneToOneField(FormAssessment, on_delete=models.CASCADE, related_name='order')
    appointment = models.OneToOneField(Appointment, on_delete=models.CASCADE, related_name='order')
